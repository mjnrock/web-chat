    ...
    return (
        <div style={{
            ...
            <Input
                ...
                icon="comment outline medium-icon blue"
                iconPosition="left"
                action={    //! Using "action" here causes a :focus bug, must convert to a flex box or similar
                    <Button color="blue" basic icon onClick={ e => props.onSubmitComment(comment) }>
                        <Icon name="send outline blue" className="medium-icon" />
                        <span style={{ paddingLeft: 6 }}>Send</span>
                    </Button>
                }
